...
import uk.co.raubach.weatherstation.server.database.codegen.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    private static final long serialVersionUID = -886757653;

    /**
     * The reference instance of <code>weatherstation_db.schema_version</code>
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.version</code>.
     */
    public final TableField<SchemaVersionRecord, String> VERSION = createField("version", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>weatherstation_db.schema_version.description</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.checksum</code>.
     */
    public final TableField<SchemaVersionRecord, Integer> CHECKSUM = createField("checksum", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>weatherstation_db.schema_version.installed_by</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.installed_on</code>.
     */
    ...
    /**
     * The column <code>weatherstation_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * Create a <code>weatherstation_db.schema_version</code> table reference
     */
    ...
    /**
     * Create an aliased <code>weatherstation_db.schema_version</code> table reference
     */
    ...
    public UniqueKey<SchemaVersionRecord> getPrimaryKey() {
        return Internal.createUniqueKey(uk.co.raubach.weatherstation.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", uk.co.raubach.weatherstation.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK);
    }
    ...
    public List<UniqueKey<SchemaVersionRecord>> getKeys() {
        return Arrays.<UniqueKey<SchemaVersionRecord>>asList(
              Internal.createUniqueKey(uk.co.raubach.weatherstation.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", uk.co.raubach.weatherstation.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK)
        );
    }
