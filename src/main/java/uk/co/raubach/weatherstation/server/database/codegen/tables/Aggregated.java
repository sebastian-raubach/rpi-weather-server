...
public class Aggregated extends TableImpl<AggregatedRecord> {
    ...
    private Aggregated(Name alias, Table<AggregatedRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public Aggregated as(Table<?> alias) {
        return new Aggregated(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Aggregated rename(Table<?> name) {
        return new Aggregated(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Aggregated where(Condition condition) {
        return new Aggregated(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Aggregated where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Aggregated where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Aggregated where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Aggregated where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Aggregated where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Aggregated where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Aggregated where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Aggregated whereExists(Select<?> select) {
     ...
     */
    @Override
    public Aggregated whereNotExists(Select<?> select) {
